//
// PageCompraContestadaTransacaoResponse.swift
//
...
public class PageCompraContestadaTransacaoResponse: JSONEncodable {

    public var content: [CompraContestadaTransacaoResponse]?
