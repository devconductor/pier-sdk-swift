//
// PageControleSegurancaDispositivoResponse.swift
//
...
public class PageControleSegurancaDispositivoResponse: JSONEncodable {

    public var content: [ControleSegurancaDispositivoResponse]?
