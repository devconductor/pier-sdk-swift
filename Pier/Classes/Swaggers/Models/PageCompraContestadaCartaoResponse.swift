//
// PageCompraContestadaCartaoResponse.swift
//
...
public class PageCompraContestadaCartaoResponse: JSONEncodable {

    public var content: [CompraContestadaCartaoResponse]?
