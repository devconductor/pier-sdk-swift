//
// PageTipoResolucaoContestacaoResponse.swift
//
...
public class PageTipoResolucaoContestacaoResponse: JSONEncodable {

    public var content: [CdtTipoResolucaoContestacao]?
