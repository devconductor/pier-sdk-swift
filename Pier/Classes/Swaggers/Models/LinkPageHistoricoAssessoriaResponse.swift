//
// LinkPageHistoricoAssessoriaResponse.swift
//
...
public class LinkPageHistoricoAssessoriaResponse: JSONEncodable {

    public var content: [LinkHistoricoAssessoriaResponse]?
