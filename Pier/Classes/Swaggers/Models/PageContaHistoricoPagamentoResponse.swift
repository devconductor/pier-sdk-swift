//
// PageContaHistoricoPagamentoResponse.swift
//
...
public class PageContaHistoricoPagamentoResponse: JSONEncodable {

    public var content: [ContaHistoricoPagamentoResponse]?
