//
// LinkPageTransferenciaBancariaResponse.swift
//
...
public class LinkPageTransferenciaBancariaResponse: JSONEncodable {

    public var content: [LinkTransferenciaBancariaResponse]?
