...
public class DispositivoAPI: APIBase {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func salvarUsingPOST9(persist persist: DispositivoPersist, completion: ((data: DispositivoResponse?, error: ErrorType?) -> Void)) {
  ...
  "token" : "aeiou"
     ...
     - returns: RequestBuilder<DispositivoResponse> 
     */
    public class func salvarUsingPOST9WithRequestBuilder(persist persist: DispositivoPersist) -> RequestBuilder<DispositivoResponse> {
        let path = "/api/dispositivos"
        let URLString = PierAPI.basePath + path
