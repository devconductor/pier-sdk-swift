...
public class UsuarioAPI: APIBase {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func alterarUsingPUT11(id id: Int, update: UsuarioUpdate, completion: ((data: UsuarioResponse?, error: ErrorType?) -> Void)) {
        alterarUsingPUT11WithRequestBuilder(id: id, update: update).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "status" : "aeiou"
     ...
     */
    public class func alterarUsingPUT11WithRequestBuilder(id id: Int, update: UsuarioUpdate) -> RequestBuilder<UsuarioResponse> {
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func consultarUsingGET32(id id: Int, completion: ((data: UsuarioResponse?, error: ErrorType?) -> Void)) {
  ...
  "status" : "aeiou"
     ...
     - returns: RequestBuilder<UsuarioResponse> 
     */
    public class func consultarUsingGET32WithRequestBuilder(id id: Int) -> RequestBuilder<UsuarioResponse> {
        var path = "/api/usuarios/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = PierAPI.basePath + path
  ...
  "status" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listarUsingGET36(sort sort: [String]?, page: Int?, limit: Int?, nome: String?, cpf: String?, email: String?, status: String?, completion: ((data: PageUsuarioResponse?, error: ErrorType?) -> Void)) {
        listarUsingGET36WithRequestBuilder(sort: sort, page: page, limit: limit, nome: nome, cpf: cpf, email: email, status: status).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "first" : true
     ...
     */
    public class func listarUsingGET36WithRequestBuilder(sort sort: [String]?, page: Int?, limit: Int?, nome: String?, cpf: String?, email: String?, status: String?) -> RequestBuilder<PageUsuarioResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func salvarUsingPOST20(persist persist: UsuarioPersist, completion: ((data: UsuarioResponse?, error: ErrorType?) -> Void)) {
        salvarUsingPOST20WithRequestBuilder(persist: persist).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "status" : "aeiou"
     ...
     - returns: RequestBuilder<UsuarioResponse> 
     */
    public class func salvarUsingPOST20WithRequestBuilder(persist persist: UsuarioPersist) -> RequestBuilder<UsuarioResponse> {
        let path = "/api/usuarios"
        let URLString = PierAPI.basePath + path
