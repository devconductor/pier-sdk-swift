...
public class StatusParametroAPI: APIBase {
  ...
  "permiteDesbloquear" : 123
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func consultarUsingGET15(id id: Int, completion: ((data: StatusContaResponse?, error: ErrorType?) -> Void)) {
  ...
  "permiteReceberTransferencia" : 123
     ...
     */
    public class func consultarUsingGET15WithRequestBuilder(id id: Int) -> RequestBuilder<StatusContaResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func consultarUsingGET16(id id: Int, completion: ((data: StatusImpressaoResponse?, error: ErrorType?) -> Void)) {
  ...
  "id" : 123456789
     ...
     */
    public class func consultarUsingGET16WithRequestBuilder(id id: Int) -> RequestBuilder<StatusImpressaoResponse> {
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listarUsingGET23(sort sort: [String]?, page: Int?, limit: Int?, id: Int?, nome: String?, completion: ((data: PageStatusImpressaoResponse?, error: ErrorType?) -> Void)) {
        listarUsingGET23WithRequestBuilder(sort: sort, page: page, limit: limit, id: id, nome: nome).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "first" : true
     ...
     */
    public class func listarUsingGET23WithRequestBuilder(sort sort: [String]?, page: Int?, limit: Int?, id: Int?, nome: String?) -> RequestBuilder<PageStatusImpressaoResponse> {
