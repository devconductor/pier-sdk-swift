...
public class OportunidadeAPI: APIBase {
  ...
  "descricao" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func alterarUsingPUT16(id id: Int, persist: TipoOportunidade, completion: ((data: TipoOportunidadeResponse?, error: ErrorType?) -> Void)) {
        alterarUsingPUT16WithRequestBuilder(id: id, persist: persist).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "descricao" : "aeiou"
     ...
     */
    public class func alterarUsingPUT16WithRequestBuilder(id id: Int, persist: TipoOportunidade) -> RequestBuilder<TipoOportunidadeResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func alterarUsingPUT9(id id: Int, update: OportunidadeUpdate, completion: ((data: OportunidadeResponse?, error: ErrorType?) -> Void)) {
  ...
  "idTipoOportunidade" : 123456789
     ...
     */
    public class func alterarUsingPUT9WithRequestBuilder(id id: Int, update: OportunidadeUpdate) -> RequestBuilder<OportunidadeResponse> {
  ...
  "descricao" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func consultarUsingGET19(id id: Int, completion: ((data: OportunidadeResponse?, error: ErrorType?) -> Void)) {
  ...
  "idTipoOportunidade" : 123456789
     ...
     - returns: RequestBuilder<OportunidadeResponse> 
     */
    public class func consultarUsingGET19WithRequestBuilder(id id: Int) -> RequestBuilder<OportunidadeResponse> {
        var path = "/api/oportunidades/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = PierAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func consultarUsingGET34(id id: Int, completion: ((data: TipoOportunidadeResponse?, error: ErrorType?) -> Void)) {
  ...
  "descricao" : "aeiou"
     ...
     - returns: RequestBuilder<TipoOportunidadeResponse> 
     */
    public class func consultarUsingGET34WithRequestBuilder(id id: Int) -> RequestBuilder<TipoOportunidadeResponse> {
        var path = "/api/tipos-oportunidades/{id}"
        path = path.stringByReplacingOccurrencesOfString("{id}", withString: "\(id)", options: .LiteralSearch, range: nil)
        let URLString = PierAPI.basePath + path
  ...
  "first" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listarUsingGET22(sort sort: [String]?, page: Int?, limit: Int?, idStatusOportunidade: Int?, dataCadastro: String?, dataAtualizacao: String?, numeroReceitaFederal: String?, dataInicioVigencia: String?, dataFimVigencia: String?, flagAtivo: Bool?, completion: ((data: PageOportunidadeResponse?, error: ErrorType?) -> Void)) {
        listarUsingGET22WithRequestBuilder(sort: sort, page: page, limit: limit, idStatusOportunidade: idStatusOportunidade, dataCadastro: dataCadastro, dataAtualizacao: dataAtualizacao, numeroReceitaFederal: numeroReceitaFederal, dataInicioVigencia: dataInicioVigencia, dataFimVigencia: dataFimVigencia, flagAtivo: flagAtivo).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "first" : true
     ...
     */
    public class func listarUsingGET22WithRequestBuilder(sort sort: [String]?, page: Int?, limit: Int?, idStatusOportunidade: Int?, dataCadastro: String?, dataAtualizacao: String?, numeroReceitaFederal: String?, dataInicioVigencia: String?, dataFimVigencia: String?, flagAtivo: Bool?) -> RequestBuilder<PageOportunidadeResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func listarUsingGET38(sort sort: [String]?, page: Int?, limit: Int?, descricao: String?, flagAtivo: Bool?, completion: ((data: PageTipoOportunidadeResponse?, error: ErrorType?) -> Void)) {
        listarUsingGET38WithRequestBuilder(sort: sort, page: page, limit: limit, descricao: descricao, flagAtivo: flagAtivo).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "first" : true
     ...
     */
    public class func listarUsingGET38WithRequestBuilder(sort sort: [String]?, page: Int?, limit: Int?, descricao: String?, flagAtivo: Bool?) -> RequestBuilder<PageTipoOportunidadeResponse> {
  ...
  "idTipoOportunidade" : 123456789
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func salvarUsingPOST22(persist persist: TipoOportunidade, completion: ((data: TipoOportunidadeResponse?, error: ErrorType?) -> Void)) {
  ...
  "descricao" : "aeiou"
     ...
     - returns: RequestBuilder<TipoOportunidadeResponse> 
     */
    public class func salvarUsingPOST22WithRequestBuilder(persist persist: TipoOportunidade) -> RequestBuilder<TipoOportunidadeResponse> {
        let path = "/api/tipos-oportunidades"
        let URLString = PierAPI.basePath + path
