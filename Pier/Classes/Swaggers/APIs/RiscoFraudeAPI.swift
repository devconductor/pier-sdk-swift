...
public class RiscoFraudeAPI: APIBase {
     ...
     */
    public class func consultarUsingGET23(id id: Int, completion: ((data: RiscoFraudeDetalhadoResponse?, error: ErrorType?) -> Void)) {
  ...
  "codigoRespostaAutorizador" : "aeiou"
     ...
     */
    public class func consultarUsingGET23WithRequestBuilder(id id: Int) -> RequestBuilder<RiscoFraudeDetalhadoResponse> {
