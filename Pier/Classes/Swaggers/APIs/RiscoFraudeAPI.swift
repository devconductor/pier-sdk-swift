...
public class RiscoFraudeAPI: APIBase {
     ...
     */
    public class func consultarUsingGET22(id id: Int, completion: ((data: RiscoFraudeDetalhadoResponse?, error: ErrorType?) -> Void)) {
  ...
  "codigoRespostaAutorizador" : "aeiou"
     ...
     */
    public class func consultarUsingGET22WithRequestBuilder(id id: Int) -> RequestBuilder<RiscoFraudeDetalhadoResponse> {
