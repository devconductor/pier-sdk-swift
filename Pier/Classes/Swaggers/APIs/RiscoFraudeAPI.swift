...
public class RiscoFraudeAPI: APIBase {
     ...
     */
    public class func consultarUsingGET15(id id: Int, completion: ((data: RiscoFraudeDetalhadoResponse?, error: ErrorType?) -> Void)) {
  ...
  "codigoRespostaAutorizador" : "aeiou"
     ...
     */
    public class func consultarUsingGET15WithRequestBuilder(id id: Int) -> RequestBuilder<RiscoFraudeDetalhadoResponse> {
