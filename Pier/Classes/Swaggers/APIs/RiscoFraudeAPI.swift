...
public class RiscoFraudeAPI: APIBase {
     ...
     */
    public class func consultarUsingGET17(id id: Int, completion: ((data: RiscoFraudeDetalhadoResponse?, error: ErrorType?) -> Void)) {
  ...
  "codigoRespostaAutorizador" : "aeiou"
     ...
     */
    public class func consultarUsingGET17WithRequestBuilder(id id: Int) -> RequestBuilder<RiscoFraudeDetalhadoResponse> {
