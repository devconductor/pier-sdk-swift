...
public class RiscoFraudeAPI: APIBase {
     ...
     */
    public class func consultarUsingGET16(id id: Int, completion: ((data: RiscoFraudeDetalhadoResponse?, error: ErrorType?) -> Void)) {
  ...
  "codigoRespostaAutorizador" : "aeiou"
     ...
     */
    public class func consultarUsingGET16WithRequestBuilder(id id: Int) -> RequestBuilder<RiscoFraudeDetalhadoResponse> {
